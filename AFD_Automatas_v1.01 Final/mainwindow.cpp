...
void MainWindow::on_pushButton_clicked(){  //Botón ingresar transición
    if(ui->comboBox->currentText() != NULL  //Combobox "Estado partida"
            && ui->comboBox_2->currentText() != NULL  //Combobox "Estado llegada"
            && !(ui->lineEdit->text().isEmpty())  //Campo de texto del símbolo no vacío
        ...
        appendToList(&listaTransiciones,e_salida,ui->lineEdit->text().toStdString(),e_llegada);
    }
    else{
...
void MainWindow::on_pushButton_3_clicked(){  //Boton terminar de ingresar estados finales/iniciales
    if(ui->listWidgetEFinales->count()>0){
...
void MainWindow::on_pushButton_5_clicked(){  //Botón aceptar en "Nuevo estado"
...
void MainWindow::on_comboBox_currentTextChanged(const QString &arg1){  //Selecciona "Nuevo estado" en combobox "Estado partida"
    if(ui->comboBox->currentText() == "Nuevo estado"){
...
void MainWindow::on_comboBox_2_currentTextChanged(const QString &arg1){ //Selecciona "Nuevo estado" en combobox "Estado llegada"
